  ...
  run: function () {
    ...
    if (this.config.register) {
      ...
      switch (this.config.type) {
        case 'component':
          register.files = "src/app/components/index.js";
          register.to = "  Vue.component('vc-"+this.name+"', require('@/"+directory+"/"+this.output.fileName+".vue'));\n}";
        break;
        case 'layout':
          register.files = "src/app/layouts/index.js";
          register.to = "  Vue.component('vl-"+this.name+"', require('@/"+directory+"/"+this.output.fileName+".vue'));\n}";
        break;
        case 'mixin':
          register.files = "src/app/mixins/index.js";
          register.to = "  Vue.mixin(require('@/"+directory+"/"+this.output.fileName+"'));\n}";
        break;
      }

      log('Registering ' + this.config.type + ' "' + this.config.name + '" globally...', 'normal');
