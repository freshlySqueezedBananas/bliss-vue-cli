...
module.exports = {
  ...
  run: function () {
    ...
    log(chalk.white.bgBlue.bold(' blue ') + chalk.white.bgMagenta.bold(' ' + actionName.present + ' ') + chalk.inverse(' ' + this.config.type + ' ') + ' ' + this.config.name);
    ...
    log(chalk.white.bgBlue.bold(' blue ') + chalk.white.bgGreen.bold(' ' + actionName.past + ' ') + chalk.inverse(' ' + this.config.type + ' ') + ' ' + this.config.name);
